    ...
    <div className="flex min-h-screen items-center justify-center bg-zinc-950 px-4">
      <div className="w-full max-w-md space-y-8 rounded-xl bg-zinc-900/50 p-8 shadow-2xl ring-1 ring-white/10 backdrop-blur-xl">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-zinc-400">{t('register.subtitle')}</p>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              >
                ...
                <option value="What is your pet's name?">{t('register.questions.petName')}</option>
                <option value="What is your mother's maiden name?">{t('register.questions.maidenName')}</option>
                <option value="What was your first car?">{t('register.questions.firstCar')}</option>
                <option value="What city were you born in?">{t('register.questions.birthCity')}</option>
              </select>
            </div>

            <div>
              <label htmlFor="securityAnswer" className="block text-sm font-medium text-zinc-400">
                {t('register.securityAnswer')}
              </label>
              <Input
                id="securityAnswer"
                type="text"
